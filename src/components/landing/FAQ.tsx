...
const faqs = [
  {
    ...
    answer: `Cost depends entirely on the scope of your project — layout changes, cabinetry, countertops, and finishes all affect the total. Sunshine Custom Builders takes on kitchen projects starting at ${business.minProjectLabel}. A consultation is the best way to get an accurate range for your specific kitchen.`,
  },
  {
    question: "What is the minimum project size?",
    answer: `We take on kitchen renovations starting at ${business.minProjectLabel}. This lets us focus on complete renovations and larger remodeling projects rather than small repairs.`,
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Design and material selection — cabinetry, countertops, flooring, and finishes — are part of the design and scope phase of our process.",
  },
  {
  ...
  return (
    <Section tone="white">
      <div className="max-w-2xl">
        ...
        <h2 className="text-3xl md:text-4xl">Kitchen Remodeling Questions, Answered</h2>
      </div>
