    ...
    <Section tone="navy">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-5 text-lg text-white/80">
          This is for homeowners planning a substantial kitchen renovation, not small handyman
          repairs. Sunshine Custom Builders takes on complete kitchen renovations and larger
